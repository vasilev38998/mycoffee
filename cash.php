...
repair_cash_register_session_numbers($from,$to);
$today=date('Y-m-d');
if($today<$from||$today>$to){repair_cash_register_payment_amounts($today,$today);repair_cash_register_session_numbers($today,$today);}
