...
<div class="card metric"><div class="label">Сейчас в кассе</div><div class="value"><?=money((float)$current['balance'])?></div><div class="meta"><?=$current['report']?'По последнему кассовому отчёту + движения после него':'Расчёт по доступной истории движений'?></div></div>
