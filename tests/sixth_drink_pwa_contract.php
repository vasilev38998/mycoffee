...
$checks=[
  ...
  'PWA loads refreshed sixth drink checkout'=>str_contains($config,'assets/sixth-drink-checkout.js?v=3')&&str_contains($config,'assets/sixth-drink-checkout.css?v=2'),
  'service worker refreshes polish and gift assets'=>str_contains($sw,"kapouch-pwa-v40")&&str_contains($sw,'./assets/sixth-drink-checkout.js?v=3')&&str_contains($sw,'./assets/sixth-drink-checkout.css?v=2')&&str_contains($sw,'./assets/pwa-polish.js?v=2')&&str_contains($sw,'./assets/hero-cup.svg?v=2'),
