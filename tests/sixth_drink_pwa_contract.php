...
$checks=[
  ...
  'profile refreshes loyalty including sixth drink'=>str_contains($profile,'customer_loyalty_refresh_customer($customerId)')&&str_contains($loyalty,'customer_drink_loyalty_refresh_customer($customerId,$limit)'),
  ...
  'PWA loads refreshed sixth drink checkout'=>str_contains($config,'assets/sixth-drink-checkout.js?v=5')&&str_contains($config,'assets/sixth-drink-checkout.css?v=3'),
  'service worker refreshes polish and gift assets'=>str_contains($sw,"kapouch-pwa-v44")&&str_contains($sw,'./assets/sixth-drink-checkout.js?v=5')&&str_contains($sw,'./assets/sixth-drink-checkout.css?v=3')&&str_contains($sw,'./assets/pwa-polish.js?v=3')&&str_contains($sw,'./assets/hero-cup.svg?v=2'),
