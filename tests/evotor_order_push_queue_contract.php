...
$dispatchStart=strpos($notifications,'function evotor_order_push_dispatch_log');
...
evotor_queue_contract_require($dispatchStart!==false&&$notifyStart!==false&&$notifyStart>$dispatchStart,'dispatch/notify functions are missing or reordered unexpectedly');
evotor_queue_contract_require($deferStart!==false&&$deferStart>$notifyStart,'queue/defer functions are missing or reordered unexpectedly');
$dispatchBody=substr($notifications,$dispatchStart,$notifyStart-$dispatchStart);
