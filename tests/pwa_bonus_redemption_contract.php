...
$checks=[
  ...
  'quote exposes balance maximum percent and applied spend'=>str_contains($quote,'loyalty_spend_max')&&str_contains($quote,'loyalty_spend_percent')&&str_contains($quote,'loyalty_spend')&&str_contains($quote,'total_before_points'),
  ...
  'fresh checkout assets are loaded'=>str_contains($config,'sixth-drink-checkout.js?v=4')&&str_contains($config,'sixth-drink-checkout.css?v=2')&&str_contains($index,'config.js?v=12')&&str_contains($index,'payments.js?v=8'),
  'service worker shell bumped'=>str_contains($sw,"kapouch-pwa-v41")&&str_contains($sw,'./assets/sixth-drink-checkout.js?v=4')&&str_contains($sw,'./assets/payments.js?v=8'),
];
