...
$checks=[
    ...
    'MAX link is rendered from catalog setting'=>str_contains($standalone,"data.shop?.max_url")&&str_contains($standalone,"link.textContent='MAX →'"),
    'PWA shell loads standalone layer'=>str_contains($index,'assets/pwa-standalone.js?v=1'),
    'service worker shell bumped and caches standalone layer'=>str_contains($sw,"kapouch-pwa-v42")&&str_contains($sw,'./assets/pwa-standalone.js?v=1'),
];
