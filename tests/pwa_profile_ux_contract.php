...
$checks=[
    ...
    'service worker cache bumped'=>str_contains($sw,"kapouch-pwa-v37")&&str_contains($sw,'./assets/contrast-fix.css?v=1')&&str_contains($sw,'./assets/status-once.js?v=1')&&str_contains($sw,'./assets/hero-cup.svg?v=1'),
];
