...
<section class="hero"><h2>Закажите заранее — заберите без ожидания</h2><p>Выберите напитки, оформите самовывоз и следите за приготовлением прямо на этой странице.</p></section>
...
<div class="drawer" id="drawer">
  ...
  <aside class="panel">
    ...
    <form class="form" id="checkoutForm" style="margin-top:14px">
      <label>Имя<input name="name" maxlength="160" placeholder="Как к вам обращаться"></label>
