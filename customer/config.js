...
window.addEventListener('DOMContentLoaded',function(){
  ...
  var loadCard=function(){
    ...
    var card=document.createElement('script');card.src='assets/loyalty-card.js?v=1';card.defer=true;card.dataset.kapouchLoyaltyCard='1';document.body.appendChild(card);
  };
