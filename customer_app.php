...
?>
<div class="card"><div class="chart-head"><div><h2>Клиентское приложение</h2><p>Единый центр управления клиентским PWA: оформление, меню, объёмы, фотографии, модификаторы, оплата, видимость и push-рассылки.</p></div><a class="btn primary" href="customer/" target="_blank">Открыть PWA ↗</a></div></div>
