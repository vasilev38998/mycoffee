...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    try{
        if($action==='design'){
            ...
            audit_write('customer_pwa_design_updated','Обновлены настройки внешнего вида клиентского PWA, включая главный баннер');flash('success','Внешний вид и главный баннер клиентского приложения сохранены.');
...
?>
<div class="card"><div class="chart-head"><div><h2>Клиентское приложение</h2><p>Единый центр управления клиентским PWA: оформление, меню, объёмы, фотографии, модификаторы, оплата, видимость, QR и push-рассылки.</p></div><a class="btn primary" href="customer/" target="_blank">Открыть PWA ↗</a></div></div>
...
<div class="alert info section"><strong>Модификаторы используют реальные товары.</strong> Альтернативное молоко, сиропы и другие платные добавки можно связать с существующими карточками Kapouch/Evotor. Цена в PWA будет браться из самой товарной карточки.</div>
