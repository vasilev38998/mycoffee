...
try{
    ...
    if($connectionId===null)customer_api_reply(401,['ok'=>false,'error'=>'Терминал Kapouch не авторизован. Получите новое push-уведомление на Эвотор после обновления приложения.']);
...
}catch(Throwable $e){customer_api_reply(500,['ok'=>false,'error'=>'Не удалось определить клиента: '.$e->getMessage()]);}
