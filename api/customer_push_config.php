...
try{$keys=customer_push_vapid_keys();customer_api_reply(200,['ok'=>true,'push'=>['public_key'=>$keys['public']]]);}catch(Throwable $e){customer_api_reply(500,['ok'=>false,'error'=>'Push-уведомления пока недоступны.']);}
