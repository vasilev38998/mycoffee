...
<div class="actions" style="margin-top:12px"><form method="post"><input type="hidden" name="csrf" value="<?=csrf_token()?>"><input type="hidden" name="action" value="process"><button class="btn ghost">Обработать до 10 сейчас</button></form></div></div>
