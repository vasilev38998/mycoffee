...
function page_header(string $title): void {
    ...
    $navGroups=[
        ['label'=>'Обзор','items'=>[
            ['index.php','Дашборд'],['control.php','Контроль'],['analytics.php','Аналитика'],['economics.php','Экономика'],['daily_report.php','Отчёт дня'],['planning.php','Планирование'],['data_quality.php','Качество данных'],
        ]],
        ['label'=>'Операции','items'=>[
            ['cash.php','Касса'],['sales.php','Продажи'],['expenses.php','Расходы'],['automatic_expenses.php','Авторасходы'],
        ]],
        ['label'=>'Меню и склад','items'=>[
            ['products.php','Меню и техкарты'],['ingredients.php','Ингредиенты'],['inventory.php','Склад'],['purchases.php','Закупки'],
        ]],
        ['label'=>'Система','items'=>[
