...
function role_pages(): array{
    ...
    return [
      ...
      'employee'=>['index.php','online_orders.php','cash.php','sales.php','inventory.php','purchases.php'],
    ];
}
