...
function kapouch_public_pages(): array{
    return [
      ...
      'customer_catalog.php','customer_order.php','customer_order_status.php','customer_order_detail.php','customer_favorites.php','customer_reorder.php','customer_manifest.php','customer_legal.php','customer_payment_yookassa_webhook.php','evotor_order_action.php',
