...
function role_pages(): array{
    $all=['index.php','control.php','analytics.php','economics.php','daily_report.php','planning.php','cash.php','sales.php','expenses.php','automatic_expenses.php','products.php','ingredients.php','inventory.php','purchases.php','integrations.php','settings.php','updates.php','users.php','audit.php','data_quality.php'];
    return [
      'owner'=>$all,
      'manager'=>array_values(array_diff($all,['users.php','audit.php','updates.php'])),
      'accountant'=>['index.php','control.php','analytics.php','economics.php','daily_report.php','planning.php','cash.php','sales.php','expenses.php','automatic_expenses.php','purchases.php','data_quality.php'],
