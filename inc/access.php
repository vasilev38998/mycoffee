...
function role_pages(): array{
    $all=['index.php','owner_brief.php','control.php','analytics.php','economics.php','daily_report.php','planning.php','budget.php','online_orders.php','online_orders_feed.php','cash.php','cash_flow.php','sales.php','expenses.php','automatic_expenses.php','products.php','recipe.php','ingredients.php','inventory.php','purchases.php','receipt_import.php','receipt_proverkacheka.php','suppliers.php','purchase_prices.php','customer_app.php','customer_qr.php','customer_operations.php','customer_marketing.php','customer_loyalty_settings.php','customer_payments.php','customer_refunds.php','customer_groups.php','customer_media.php','customer_modifiers.php','pwa_visibility.php','push_notifications.php','integrations.php','settings.php','updates.php','users.php','audit.php','data_quality.php'];
    return [
      'owner'=>$all,
...
function kapouch_public_pages(): array{
    return [
      'login.php','logout.php','install.php','api_online_orders.php','receipt_proverkacheka_proxy.php','manifest.php',
      'customer_catalog.php','customer_order.php','customer_order_status.php','customer_order_detail.php','customer_favorites.php','customer_reorder.php','customer_manifest.php','customer_legal.php','customer_payment_yookassa_webhook.php','evotor_order_action.php','evotor_customer_lookup.php',
