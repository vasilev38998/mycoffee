...
function role_pages(): array{
    $all=['index.php','control.php','analytics.php','economics.php','daily_report.php','planning.php','budget.php','cash.php','sales.php','expenses.php','automatic_expenses.php','products.php','ingredients.php','inventory.php','purchases.php','suppliers.php','purchase_prices.php','integrations.php','settings.php','updates.php','users.php','audit.php','data_quality.php'];
    return [
      'owner'=>$all,
      'manager'=>array_values(array_diff($all,['users.php','audit.php','updates.php'])),
      'accountant'=>['index.php','control.php','analytics.php','economics.php','daily_report.php','planning.php','budget.php','cash.php','sales.php','expenses.php','automatic_expenses.php','purchases.php','suppliers.php','purchase_prices.php','data_quality.php'],
      'employee'=>['index.php','cash.php','sales.php','inventory.php','purchases.php'],
    ];
}
...
function require_page_access(): void{
    ...
    $public=['login.php','logout.php','install.php'];
